...
/// @dev These files have been copy-pasted from https://github.com/safe-global/safe-smart-account/tree/v1.4.1-build.0
/// @dev Don't waste time importing because it has overlaps & conflicts with IERC165 from openzeppelin-contracts lib

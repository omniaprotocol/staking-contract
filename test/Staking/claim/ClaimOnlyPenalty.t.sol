...
contract ClaimOnlyPenaltyTest is ClaimBase {
    ...
    function testManyEpochsLaterStart() public {
        ...
        _addMeasurement(13, NODE_1_ID, 1000, 28, Staking.NodeSlaLevel.Diamond);
    ...
    function testClaimExtraMeasurements() public {
        ...
        _addMeasurementsEpochInterval(1, 2, NODE_1_ID, 1000, 28, Staking.NodeSlaLevel.Diamond);
    ...
    function testMultipleEpochs() public {
        ...
        _addMeasurementsEpochInterval(1, epochCount, NODE_1_ID, 1000, 28, Staking.NodeSlaLevel.Diamond);
    ...
    function testMultiplePoorRpsEpochs() public {
        ...
        _addMeasurementsEpochInterval(1, epochCount, NODE_1_ID, 25, 28, Staking.NodeSlaLevel.Diamond);
    ...
    function testSmallMinStakingPoorRps() public {
        ...
        _addMeasurementsEpochInterval(1, 1, NODE_1_ID, 25, 28, Staking.NodeSlaLevel.Diamond);
    ...
    function testChangedPenaltyRate() public {
        ...
        _addMeasurement(1, NODE_1_ID, 1000, 28, Staking.NodeSlaLevel.Silver);
